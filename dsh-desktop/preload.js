...
function renderMenu() {
  ...
  menuEl.innerHTML = `
    <div class="dch-mh">
      <div class="dch-mh-title">DeepSeek Harness Desktop <span style="font-weight:400;color:var(--dsw-alias-label-tertiary)">v${esc(state.appVersion)}</span></div>
    ...
    <div class="dch-sep"></div>
    <button class="dch-item" data-act="about">关于 DeepSeek Harness Desktop</button>
...
function injectChrome() {
  ...
  bar.innerHTML = `
    <div class="dch-left">
      ...
      <span class="dch-title">DeepSeek Harness Desktop</span>
